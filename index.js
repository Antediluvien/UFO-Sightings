...
for (let index = 0; index < data.length; index += 1) {
  // console.log(index); // this logs 0, 1, 2, 3
  // console.log(data[index]); // this logs {...}, {...}, {...}, {...}
  Datetime.push("Datetime #" + (index + 1) + " : " + data[index].datetime) // this logs "BMW", "Mercedes", "Subaru", "Toyota"
  City.push("City #" + (index + 1) + " : " + data[index].city) // this logs "BMW", "Mercedes", "Subaru", "Toyota"
  State.push("State #" + (index + 1) + " : " + data[index].state) // this logs "BMW", "Mercedes", "Subaru", "Toyota"
  Country.push("Country #" + (index + 1) + " : " + data[index].country) // this logs "BMW", "Mercedes", "Subaru", "Toyota"
  Shape.push("Shape #" + (index + 1) + " : " + data[index].shape) // this logs "BMW", "Mercedes", "Subaru", "Toyota"
  DurationMinutes.push("DurationMinutes #" + (index + 1) + " : " + data[index].durationMinutes) // this logs "BMW", "Mercedes", "Subaru", "Toyota"
  Comments.push("Comment #" + (index + 1) + " : " + data[index].comments) // this logs "BMW", "Mercedes", "Subaru", "Toyota"
}

// function tableCreate() {
//   var tbl = document.createElement('table-area')
...
targetDomId = "table-area"
// targetDomId = "ufo-table"
function createTable(targetDomId, data) {
  var canvas = document.getElementById(targetDomId);

  if (canvas == undefined) {
    console.error('The target DOM id supplied to createTable() could not be selected: ', targetDomId);
    return;
  }

  // canvas.innerHTML = ''; // wipe contents
...
function myFunction() {
  // Declare variables 
  console.log("you are in the last function")
